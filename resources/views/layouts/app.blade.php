        ...
        <div class="offcanvas-body bg-dark p-0">
              <div class="d-flex flex-column flex-shrink-0 bg-dark" style="">
                <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                    ...
                    <!-- Puedo unificar las funcionalidades pensadas dentro de profile! -->
                    <!-- <li> 
                        <a href="{{ route('dashboard.settings') }}" class="nav-link {{ (Request::is('dashboard/settings') ) ? 'active' : '' }} py-3" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Settings" data-bs-trigger="hover">
